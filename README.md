...
Create and run the application in argocd
   ...
   1. Create namespace where you want to deploy the application, below is the example application
   ...
   2. Create application and specify the namespace(if used).
      ...
      <img width="1436" height="614" alt="image" src="https://github.com/user-attachments/assets/ed05ff45-85a4-49f7-84c7-d86b3f54b10b" />
      <img width="1448" height="732" alt="image" src="https://github.com/user-attachments/assets/1c4e26d4-2185-411e-a338-e44e6f395511" />
...
Cleanup
   ...
   You can see the resources in the namespace is cleared
...
Error detection use case:
   ...
   2. Result, the error was resolved
