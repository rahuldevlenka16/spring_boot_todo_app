...
| [`argo_cd`](https://github.com/rahuldevlenka16/spring_boot_todo_app/tree/argo_cd) | GitOps deployment using Argo CD for automated sync to the cluster | ✅ Completed |
